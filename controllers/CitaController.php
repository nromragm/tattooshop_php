    ...
    class CitaController {
        ...
        */
        ...
        public function showAltaCita($errores = []) {
            $tatuadores = $this->tatuadorModel->getAllTatuadores(); // Obtiene los tatuadores
            require_once "./views/citasViews/AltaCitaView.php";
        }

        public function showConfirmacionCita() {
            require_once "./views/citasViews/ConfirmacionCitaView.php";
        }
